 ...
 class FeedItem
 {
	...
	*/
	...
	public function setTitleImageUrl($titleImageUrl){
		$this->addElement('titleImage', $titleImageUrl);
	}
	...
	public function setLastAccessDate($lastAccessDate){
		$this->addElement('lastAccessDate', $lastAccessDate);
	}
	
	public function setProxyId($proxyId){
		$this->addElement('proxyId', $proxyId);
	}
	
	public function setOriginDesc($originDesc){
		$this->addElement('originDesc', $originDesc);
	}
