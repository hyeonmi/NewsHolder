					...
					listeners:{
						swipe:{
							fn:function(event){
								...
								if(localStorage.pageFlag==null){
									localStorage.pageFlag = "articleContent";
								}
								var pageFlag = null;
								var panel = null;
								var data = null;
								if(localStorage.pageFlag=="articleContent"){
									panel = Ext.getCmp("articleContent2");
									pageFlag = "articleContent2";
									animation.onMoveSlideLeft('키워드 모음', 'articleContent2', ['articleContent'], ['articleContent2']);
								}else{
									panel = Ext.getCmp("articleContent");
									pageFlag = "articleContent";
									animation.onMoveSlideLeft('키워드 모음', 'articleContent', ['articleContent2'], ['articleContent']);
								}
			   ...
			   },
			   {
				   xtype:"panel",
					...
					listeners:{
						swipe:{
							fn:function(event){
								console.log("articleContent2 swipe");
